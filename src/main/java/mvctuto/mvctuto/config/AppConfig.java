 ...
 * org.springframework.http.converter.json.Jackson2ObjectMapperBuilder; import
 * org.springframework.http.converter.json.MappingJackson2HttpMessageConverter; import
 ...
 * @Configuration
 *
 * @ComponentScan("mvctuto.mvctuto")
 *
 * @EnableJpaRepositories("mvctuto.mvctuto.repository")
 *
 * @EnableWebMvc public class AppConfig implements WebMvcConfigurer {
 *
 * @Override public void configureMessageConverters(List<HttpMessageConverter<?>>
